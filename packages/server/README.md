...
and [~15× faster to verify](https://github.com/ninsho/ninsho/blob/main/PERFORMANCE.md)
...
[README](https://github.com/ninsho/ninsho#readme) ·
[Security model and threat model](https://github.com/ninsho/ninsho/blob/main/SECURITY.md) ·
[Performance](https://github.com/ninsho/ninsho/blob/main/PERFORMANCE.md) ·
[Example API](https://github.com/ninsho/ninsho/tree/main/examples/express-api)
